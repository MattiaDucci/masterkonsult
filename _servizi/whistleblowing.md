...
## MK è disponibile ad erogare servizi aggiuntivi quali:
...
## Condizioni di erogazione del servizio di Whistleblowing

E' possibile fruire del servizio in abbonamento per la durata di 3 anni al prezzo annuale di:
    ...
    <form name="whistleblowing" action="{{ site.baseurl }}/contact-success/" method="post" class="contact-form"
			...
			<div class="halves">
                <div>
					...
					<input type="text" name="nome-azienda" id="factory-name" placeholder="Apple Inc." required />
				</div>
				<div>
